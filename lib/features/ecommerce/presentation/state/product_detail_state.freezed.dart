...
class _$ProductDetailStateImpl implements _ProductDetailState {
  ...
  @override
  String toString() {
    return 'ProductDetailState(currentImageIndex: $currentImageIndex, productImages: $productImages, name: $name, price: $price, description: $description, availableSizes: $availableSizes, selectedSize: $selectedSize, availableColors: $availableColors, selectedColorIndex: $selectedColorIndex, isFavorite: $isFavorite)';
  }
