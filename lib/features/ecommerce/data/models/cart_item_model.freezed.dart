...
class _$CartItemModelImpl extends _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(productId: $productId, productName: $productName, productImagePath: $productImagePath, productPrice: $productPrice, productSizes: $productSizes, productColors: $productColors, quantity: $quantity, selectedSize: $selectedSize, selectedColor: $selectedColor)';
  }
