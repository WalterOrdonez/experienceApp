...
mixin _$LoginState {
  ...
  bool get isCheckingSession => throw _privateConstructorUsedError;
...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, isLoading: $isLoading, isCheckingSession: $isCheckingSession, isLogged: $isLogged, obscurePassword: $obscurePassword, user: $user, errorMessage: $errorMessage)';
  }
